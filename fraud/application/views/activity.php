          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <a href="getcase/<?php echo $cases->FILENAME;?>" type="button" class="btn btn-primary btn-xs"><i class="fa fa-download"></i><span>Download Evidence</span></a>
                  </div>
                </div>
            </div>
          </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="getact/<?php echo $act->FILENAME;?>" type="get" class="btn btn-danger">View</a></td>
                      </tr>
                      <?php endforeach; ?>
                      </tbody>
                      <tfoot>
