...
@section('content')
      ...
      <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{URL::to('closesearch')}}"><i class="fa fa-list"></i> <span>View Closed Case</span></a></li>
         ...
         <div class="col-md-6">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <form action="{{URL::to('closesearchdate')}}" method="get">
                  ...
                  <div class="tab-pane" id="tab_3">
                    <form action="{{URL::to('closesearchcustomer')}}" method="get">
                    <div class="form-group">
                    <label>Nama CC:</label>
                  ...
                  <form action="{{URL::to('closesearcham')}}" method="get">
                  <div class="form-group">
                    <label>Nama AM:</label>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{URL::to('closedactivity')}}/{{$number->id_case}}" type="get" class="btn btn-success">View</a></td>
                      </tr>
                      @endforeach
                      </tbody>
                      <tfoot>
